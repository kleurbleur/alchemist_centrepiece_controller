...
// Firmware version
char firmware_version[] = "0.6";                                // We now have a gpio extender which has 5VDC outputs!
...
// PIN ASSIGNMENT
// OUT
const int motor_controller_arm_A_start_pin = 5;
const int motor_controller_arm_A_end_pin = 6;
const int motor_controller_arm_A_pause_pin = 7;
const int motor_controller_arm_A_enable_pin = 4;
const int arm_A_solenoid_safety_pin = 32;          //mod-io relay board
const int motor_controller_arm_B_start_pin = 9;
const int motor_controller_arm_B_end_pin = 10;
const int motor_controller_arm_B_pause_pin = 11;
const int motor_controller_arm_B_enable_pin = 8;
...
const int motor_controller_rings_continue_pin = 3;
const int led_hole_pin = 39;                      //ESP32 gpio output (nog te solderen)
// IN
const int inductive_sensor_A_top_pin = 13;        // mod-io relay board
const int inductive_sensor_A_bottom_pin = 14;     // mod-io relay board
...
const int inductive_sensor_B_top_pin = 33;        // mod-io relay board
const int inductive_sensor_B_bottom_pin = 34;     // mod-io relay board
...
const byte SX1509_ADDRESS = 0x3E;     // GPIO Externder SX1509 I2C address (set by ADDR1 and ADDR0 (00 by default 0x3E):
SX1509 GPIO_1;                        
...
void setup() {
  ...
  if (GPIO_1.begin(SX1509_ADDRESS) == false)
  {
  ...
  GPIO_1.pinMode(motor_controller_rings_enable_pin, OUTPUT);  //Use GPIO_OUT and GPIO_IN instead of OUTPUT and INPUT_PULLUP
  GPIO_1.pinMode(motor_controller_rings_start_pin, OUTPUT);
  GPIO_1.pinMode(motor_controller_rings_pause_pin, OUTPUT);
  GPIO_1.pinMode(motor_controller_rings_continue_pin, OUTPUT);
